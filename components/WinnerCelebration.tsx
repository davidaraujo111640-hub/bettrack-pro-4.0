    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden pointer-events-none">
      ...
      <div className="relative z-10 flex flex-col items-center animate-bounce-in">
        ...
        <div className="mt-12 flex gap-8">
            <Trophy size={60} className="text-[#ffcc00] animate-bounce-custom-1" />
            <TrendingUp size={60} className="text-emerald-400 animate-bounce-custom-2" />
            <Crown size={60} className="text-[#ffcc00] animate-bounce-custom-3" />
        </div>
      </div>
